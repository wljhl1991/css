...
<body><center>
	...
	区县:<select id = "town" name = "town" onchange="change();">
 ...
 <br/>
	...
	楼宇名称:<input type="text" name = "name" id="name" value="输入楼宇名称" onfocus="cleanInput();" onblur="insertInput();"></input>
   ...
   <br/>
   <input type="checkbox" name="copyStyle" value="checkbox2"/>(是否复制样式，方便测试使用！)
		<br>     
